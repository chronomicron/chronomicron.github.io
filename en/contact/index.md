...
- ![IEEE](/assets/icons/alpha/ieee-logo.png) **IEEE Xplore Author Profile** — [ieeexplore.ieee.org/author/38272216600](https://ieeexplore.ieee.org/author/38272216600)  
  Peer-reviewed IEEE publications.

- ![Google Scholar](/assets/icons/alpha/google-scholar-logo.png) **Google Scholar** — [Scholar profile](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=grou-szabo%2C+robert&btnG=)  
...
- ![Polytechnique Montréal](/assets/icons/alpha/polytechnique-montreal-logo.png) **Polytechnique Montréal** — [Publications profile](https://publications.polymtl.ca/view/person/Grou-Szabo,_R=2E.html)  
  Institutional record of papers and research activity.

- ![University of Tokyo](/assets/icons/alpha/university-of-tokyo-logo.png) **University of Tokyo PhD Thesis** — [Thesis record](https://gakui.dl.itc.u-tokyo.ac.jp/cgi-bin/gazo.cgi?no=127214)  
...
- ![WordPress](/assets/icons/alpha/wordpress-logo.png) **Personal blog (Japan era)** — [chronomicron.wordpress.com](https://chronomicron.wordpress.com/)
